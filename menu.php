                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_user.php" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-floating mb-3"">
                                            <input type=" password" class="form-control" id="floatingInput" placeholder="Password" disabled value="*****" name="password">
                            ...
                            <div class="modal-body">
                                ...
                                <form class="needs-validation" novalidate action="proses/proses_edit_user.php" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                                                <input <?php echo ($row['username'] == $_SESSION['username_warung']) ? 'disabled' : ''; ?> type="email" class="form-control" id="floatingInput" placeholder="name@example.com" name="username" required value="<?php echo $row['username'] ?>">
                                                <label for="floatingInput">Username</label>
                                                <div class="invalid-feedback">
                                                    Masukkan Username.
                                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form class="needs-validation" novalidate action="proses/proses_delete_user.php" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-danger" name="input_user_validate" value="12345" <?php echo ($row['username'] == $_SESSION['username_warung']) ? 'disabled' : ''; ?>>Hapus</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="modal-body">
                                ...
                                <form class="needs-validation" novalidate action="proses/proses_reset_password.php" method="POST">
                                    ...
                                    <div class="col-lg-12">
                                        <?php
                                        if ($row['username'] == $_SESSION['username_warung']) {
                                            echo "<div class='alert alert-danger'>Anda tidak dapat mereset password ini.</div>";
                                        } else {
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-success" name="input_user_validate" value="12345" <?php echo ($row['username'] == $_SESSION['username_warung']) ? 'disabled' : ''; ?>>Reset Password</button>
                                    </div>
                                </form>
                            </div>
                        </div>
